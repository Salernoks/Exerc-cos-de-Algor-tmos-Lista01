  ...
  import java.util.Scanner;
    public class Exercício06 {
       public static void main (String [] args){
        ...
        int r, Aa;
        double pi, Aaa;
           System.out.println("B) calcular a área do círculo de raio C. (PI = 3.14159)." );
           ...
           System.out.println("c) Calcular a área do trapézio que tem A e B por bases e C por altura.");
           System.out.println("Digite a base 1 do trapés");
    }
}
